  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <Card
          mediaSource={{
            uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/NEO_lake_eyre_big.jpg/600px-NEO_lake_eyre_big.jpg',
          }}
          style={{margin: 10}}>
          <CardTitle
            subtitleAbove={false}
          ...
          <CardAction separator={true} inColumn={false}>
            <CardButton onPress={() => {}} title="Action 1" />
            <CardButton onPress={() => {}} title="Action 2" />
          </CardAction>
        </Card>
        <Card
          mediaSource={{
        ...
        <Card style={{margin: 10, borderRadius: 20}}>
          <CardImage
            source={{
              uri: 'https://cdn.pixabay.com/photo/2016/08/31/17/41/sunrise-1634197_960_720.jpg',
            }}
